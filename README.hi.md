...
KIOKU आपकी बातचीत को **स्वचालित रूप से Wiki में संचित** करता है और **अगले सेशन में उन्हें वापस लाता** है।
...
1. Obsidian में एक नया Vault बनाएं (उदा., `~/kioku-vault/main`)
2. GitHub पर एक Private रिपॉजिटरी बनाएं (उदा., `kioku-vault`)
...
|---|---|---|
| `OBSIDIAN_VAULT` | none (आवश्यक) | Vault रूट। auto-ingest/lint `${HOME}/kioku-vault/main` पर फ़ॉलबैक करते हैं |
...
- लोकल stdio MCP सर्वर (`mcp/`) छह टूल्स प्रदान करता है — `kioku_search`, `kioku_read`, `kioku_list`, `kioku_write_note`, `kioku_write_wiki`, `kioku_delete`
