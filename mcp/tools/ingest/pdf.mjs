...
export const INGEST_PDF_TOOL_DEF = {
  ...
  title: 'Ingest a PDF or markdown source into KIOKU Wiki (deprecated — use kioku_ingest_document)',
  description:
    '[Deprecated in v0.5+ — use kioku_ingest_document. This alias will be removed in v0.7.] ' +
...
function buildIngestPrompt({ vault, chunkPages, subdirPrefix, stem, ext, needIngest }) {
  ...
  return [
    ...
    '- **重要な順序**: まず全 chunk summary (pp001-015.md / pp015-030.md / ...) を書き上げること。',
    '  全 chunk 完了後に、それら全てを横断する index.md を synthesis として作成すること',
    '  (各 chunk summary への wikilink + 全体の要旨)。chunk summary を書く前に index.md を先に書くと、',
    '  後半 chunk の内容が index に反映されず不完全な synthesis になる。',
