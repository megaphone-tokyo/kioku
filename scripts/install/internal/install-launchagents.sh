...
AUTO_INGEST_ABS="${TOOL_ROOT}/scripts/auto-ingest.sh"
AUTO_LINT_ABS="${TOOL_ROOT}/scripts/auto-lint.sh"
...
# VULN-005: パスのバリデーション (validate_vault_path は lib/install-common.sh の SSOT、PR S6-1)
